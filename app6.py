...
def predict():
    ...
    data2 = {
        'Date': pd.date_range(start='07/01/2024', periods=26).strftime('%m/%d/%Y').tolist(),
    ...
    predicted_data3 = df3.to_dict(orient='records')
    converted_data3 = convert_dates(predicted_data3)
    extracted_data3 = extract_columns(converted_data3, columns_to_extract)
    #return jsonify(extracted_data)
    return jsonify({'stock1': predicted_data, 'stock2': predicted_data3})
